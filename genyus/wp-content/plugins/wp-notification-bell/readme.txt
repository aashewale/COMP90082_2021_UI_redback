...
Donate link: https://paypal.me/wsamya
Tags:  notifications, alert, woocommerce, bbPress, ajax, live, message, comments, woocommerce notifications
...
On-site bell notifications. Display notifications custom or triggered (new posts/cpts, new comment replies, WooCommerce customer updates, bbPress...)
== Description ==
Bell notifications for your website users. Display a real-time notification feed with notifications created manually or through triggers (new posts/cpts, WooCommerce, new comment replies, bbPress...).
WP Notification Bell is a custom notification and bell alert plugin for WordPress. (not push)
...
* Delete or trash notifications on posts or custom post types deletion
* Custom edit user notifications default message (modify content, add date...)

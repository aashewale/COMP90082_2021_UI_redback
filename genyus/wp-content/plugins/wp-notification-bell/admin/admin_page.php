...
<p class="description">If add bell icon to menu is enabled, it will be add in this location (optional)</p>
 </td>
 </tr>
   <!-- <tr style="vertical-align:bottom">
    <th scope="row"><?php 
 ...
 <tr style="vertical-align:bottom">
    ...
    value="<?php 
            ...
            ?>"/>
    <p class="description">If add bell icon to menu is enabled, it will be add in this position (optional)</p>
   </td>
   </tr>
   <tr style="vertical-align:bottom">
               <th scope="row"><?php 
 ...
 <?php 
        ...
        <p class="description">Enable this option and fill the notification content in the metabox that will appear in the post editor.</p>
   </td>
   </tr>
   <tr style="vertical-align:bottom">
 ...
 <?php 
        ...
        <p class="description">Enable this option and fill the notification content in the metabox that will appear in the custom post type (selected below) post editor.</p>
   </td>
   </tr>
   <tr style="vertical-align:bottom">
    <th scope="row"><?php 
